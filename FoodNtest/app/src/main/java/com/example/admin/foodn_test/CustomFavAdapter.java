...
public class CustomFavAdapter extends BaseAdapter {
    ...
    List<DATABASE_FAV.DbRecord> dbList;
    public CustomFavAdapter(Context context, List<DATABASE_FAV.DbRecord>
    ...
    @Override
    public DATABASE_FAV.DbRecord getItem(int position) {
